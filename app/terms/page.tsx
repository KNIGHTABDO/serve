      ...
      <div className="relative z-10 w-full min-h-screen pointer-events-auto overflow-y-auto px-6 py-24 sm:py-32">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12 text-sm md:text-base font-light text-white/60 leading-relaxed border-l border-white/10 pl-6 md:pl-8">
            <section>
              <h2 className="text-white/90 text-lg md:text-xl mb-4 tracking-wide">License</h2>
            ...
            <section>
              <h2 className="text-white/90 text-lg md:text-xl mb-4 tracking-wide">Service Availability</h2>
            ...
            <section>
              <h2 className="text-white/90 text-lg md:text-xl mb-4 tracking-wide">Responsibility</h2>
