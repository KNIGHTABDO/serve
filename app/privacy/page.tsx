      ...
      <div className="relative z-10 w-full min-h-[100dvh] pointer-events-auto px-6 py-24 sm:py-32">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12 text-sm md:text-base font-light text-ivory/60 leading-relaxed border-l border-amber/15 pl-6 md:pl-8">
            <section>
              <h2 className="font-serif italic font-medium text-ivory/95 text-lg md:text-xl mb-4 tracking-wide">Local-First Architecture</h2>
            ...
            <section>
              <h2 className="font-serif italic font-medium text-ivory/95 text-lg md:text-xl mb-4 tracking-wide">LLM Integration</h2>
            ...
            <section>
              <h2 className="font-serif italic font-medium text-ivory/95 text-lg md:text-xl mb-4 tracking-wide">Telemetry</h2>
